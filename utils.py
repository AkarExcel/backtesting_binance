...
STRAT_PARAMS = {
    ...
    "sup_res": {
        ...
        "rounding_nb": {"name": "Rounding Number", "type": float,"min": 500, "max": 6000, "decimals": 2},
        "take_profit": {"name": "Take Profit %", "type": float, "min": 1, "max": 60, "decimals": 2},
        "stop_loss": {"name": "Stop Loss %", "type": float,"min": 1, "max": 25, "decimals": 2},
    },
    "sma": {
    ...
    "psar": {
        ...
        "max_acc": {"name": "Max. Acceleration", "type": float, "max": 1, "min": 0.05,"decimals": 2},
    },
}
